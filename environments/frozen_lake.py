...
MAPS = {
    ...
    "20x20": [
        "FFFFFFFFFFFFFFHFFFFG",
        "FFHHHHHHFFFHHHHHHHFF",
        "FFFFFFFFFFFFFFFFFFFF",
        "FFHHHHHHHHHHHHHHHHFF",
        "FFHHHHHHHHHHHHHHHHFF",
        "FFHHHHHHHHHHHHHHHHFF",
        "FFFFFFFFFFFFFFFFFFFF",
        "FFFFFFFFFFFFFFFFFFFF",
        "FFFFFFFFFFFFFFFFFFFF",
        "HHHHFFFHHFFFHHFFFHHH",
        "HHHHFFFHHFFFHHFFFHHH",
        "FFFFFFFFFFFFFFFFFFFF",
        "FFFFFFFFFFFFFFFFFFFF",
        "FFFFFFFFFFFFFFFFFFFF",
        "FFFHHFHHHHFHHHHFHHHH",
        "FFFFFFFFFFFFFFFFFFFF",
        "FFFFFFFFFFFFFFFFFFFF",
        "FFFFFFFFFFFFFFFFFFFF",
        "HSHHHHHHHHHHHHHHHHHH",
...
class RewardingFrozenLakeEnv(discrete.DiscreteEnv):
    ...
    def __init__(self, desc=None, map_name="4x4", rewarding=True, step_reward=-0.001, hole_reward=-1, is_slippery=True):
