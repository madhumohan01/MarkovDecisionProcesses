...
class PolicyIterationExperiment(BaseExperiment):
    ...
    def perform(self):
        ...
        with open(grid_file_name, 'w') as f:
            f.write("params,time,steps,reward_mean,reward_median,reward_min,reward_max,reward_std,steps_new\n")
        ...
        for discount_factor in discount_factors:
            ...
            with open(grid_file_name, 'a') as f:
                ...
                # print(optimal_policy_stats)
                # print(optimal_policy_stats.rewards)
                # print(stats.converged_values, len(stats.converged_values))
            runs += 1
